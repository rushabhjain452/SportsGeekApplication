                ...
                >
                    <View style={styles.boxContainer}>
                        <TouchableOpacity style={[styles.box, card1Style]} onPress={() => setSelectedTeamId(matchData.team1Id)}>
                            ...
                            <View>
                                <Text style={styles.txtContestPoints}>{team1BetPoints} points</Text>
                            </View>
                            <View>
                        ...
                        <TouchableOpacity style={[styles.box, card2Style]} onPress={() => { setSelectedTeamId(matchData.team2Id) }}>
                            ...
                            <View>
                                <Text style={styles.txtContestPoints}>{team2BetPoints} points</Text>
                            </View>
                            <View>
                    ...
                    <View style={styles.boxContainer}>
                        <Text style={styles.main_header}>Bets for this Match</Text>
                    </View>
